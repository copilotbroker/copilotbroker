...
BEGIN
  ...
  IF _existing_personal_id IS NOT NULL AND _existing_personal_id <> _src.id THEN
    ...
    IF _src.lead_id IS NOT NULL THEN
      ...
      VALUES (_src.lead_id, 'lead_unificado'::interaction_type, 'Conversa do WhatsApp Plantão unificada na instância pessoal do corretor', _caller_broker_id, 'whatsapp');
    END IF;
