...
interface CA2727FormSectionProps {
  projectId?: string;
  brokerId?: string;
  submitted?: boolean;
...
const CA2727FormSection = ({ projectId, brokerId, submitted, allowBrokerSelection = true }: CA2727FormSectionProps) => {
        ...
        <div className={`max-w-xl mx-auto transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="text-center mb-10">
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
              QUERO CONHECER{" "}
              <span className="text-gold-gradient">ESTA CASA</span>
            </h2>
          ...
          {submitted ? (
            <div className="card-luxury p-8 md:p-10 flex flex-col items-center justify-center text-center space-y-4 min-h-[200px]">
              ...
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-foreground">
                Obrigado pelo seu{" "}
                <span className="text-gold-gradient">interesse!</span>
              </h3>
              <p className="text-muted-foreground">
            ...
            <form onSubmit={handleSubmit} className="card-luxury p-8 md:p-10 space-y-6">
              <div>
                <label htmlFor="ca2727-name" className="block text-sm font-medium text-foreground/80 mb-2">
                  Nome Completo
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="ca2727-whatsapp" className="block text-sm font-medium text-foreground/80 mb-2">
                  WhatsApp
                </label>
                <WhatsAppInput
                  id="ca2727-whatsapp"
              ...
              <div className="flex items-start gap-3">
                <Checkbox
                  ...
                  disabled={isSubmitting}
                />
                <label htmlFor="ca2727-terms" className="text-sm text-foreground/80 leading-relaxed cursor-pointer">
                  Li e aceito os{" "}
                  <Link
                    to="/termos"
                    target="_blank"
...
export default CA2727FormSection;
