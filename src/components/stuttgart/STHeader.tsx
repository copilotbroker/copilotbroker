...
const STHeader = ({ brokerName }: STHeaderProps) => {
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 md:gap-4">
              <img src={logoEnove} alt="Enove" className="h-6 md:h-8 w-auto brightness-0 invert opacity-80" />
              {brokerName && (
        ...
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <nav className="absolute top-16 left-4 right-4 bg-card rounded-lg shadow-2xl p-6 border border-border/50 animate-fade-up">
            ...
            <div className="mt-4 pt-4 border-t border-border/30">
              <button onClick={() => scrollToSection("cadastro")} className="w-full btn-primary min-h-[48px]">
                Quero Acesso Antecipado
              </button>
            </div>
          </nav>
