...
const benefits = [
  ...
  { icon: CheckCircle2, text: "Prioridade real na escolha das unidades" },
  { icon: Bell, text: "Informações antes da divulgação pública" },
  { icon: Phone, text: "Contato direto no momento de abertura" },
];

const STBenefitsSection = () => {
  ...
  return (
    <section id="beneficios" ref={sectionRef} className="py-20 md:py-32 bg-background relative overflow-hidden">
      <div className="container px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <p className="font-serif text-xl md:text-2xl text-primary">É para quem quer:</p>
          </div>
...
export default STBenefitsSection;
