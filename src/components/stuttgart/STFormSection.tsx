...
const STFormSection = ({ projectId, brokerId, submitted, allowBrokerSelection = true }: STFormSectionProps) => {
        ...
        <div className={`max-w-xl mx-auto transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="card-luxury p-8 md:p-10 space-y-6">
              <div>
                <label htmlFor="st-name" className="block text-sm font-medium text-foreground/80 mb-2">Nome Completo</label>
                <input
                  type="text"
                  id="st-name"
                  name="name"
              ...
              <div>
                <label htmlFor="st-whatsapp" className="block text-sm font-medium text-foreground/80 mb-2">WhatsApp</label>
                <WhatsAppInput
                  id="st-whatsapp"
                  name="whatsapp"
                  autoComplete="tel"
              ...
              <div className="flex items-start gap-3">
                <Checkbox
                  ...
                  disabled={isSubmitting}
                />
                <label htmlFor="st-terms" className="text-sm text-foreground/80 leading-relaxed cursor-pointer">
                  Li e aceito os{" "}
                  <Link to="/ivoti/stuttgart/termos#termos-de-uso" target="_blank" className="text-primary hover:text-primary/80 underline underline-offset-2">
                    Termos de Uso
                  </Link>{" "}
                  e a{" "}
                  <Link to="/ivoti/stuttgart/termos#politica-de-privacidade" target="_blank" className="text-primary hover:text-primary/80 underline underline-offset-2">
