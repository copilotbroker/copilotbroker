  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" aria-labelledby="hero-heading">
      <div
        ...
        role="img"
        aria-label="Vista aérea do Aura Legano em Nova Santa Rita"
      />
        ...
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 mb-6 border border-primary/40 rounded-full bg-primary/10 backdrop-blur-sm">
            ...
            <span className="text-[9px] sm:text-xs font-medium tracking-widest uppercase text-primary">
              Últimos 15 Lotes · Entrega Julho/2026
            </span>
          </div>
