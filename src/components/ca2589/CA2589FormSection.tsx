...
interface CA2589FormSectionProps {
  projectId?: string;
  brokerId?: string;
  submitted?: boolean;
...
const CA2589FormSection = ({ projectId, brokerId, submitted, allowBrokerSelection = true }: CA2589FormSectionProps) => {
        ...
        <div className={`max-w-xl mx-auto transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="card-luxury p-8 md:p-10 space-y-6">
              <div>
                <label htmlFor="ca2589-name" className="block text-sm font-medium text-foreground/80 mb-2">
                  Nome Completo
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="ca2589-whatsapp" className="block text-sm font-medium text-foreground/80 mb-2">
                  WhatsApp
                </label>
                <WhatsAppInput
                  id="ca2589-whatsapp"
              ...
              <div className="flex items-start gap-3">
                <Checkbox
                  ...
                  disabled={isSubmitting}
                />
                <label htmlFor="ca2589-terms" className="text-sm text-foreground/80 leading-relaxed cursor-pointer">
                  Li e aceito os{" "}
                  <Link
                    to="/termos"
                    target="_blank"
...
export default CA2589FormSection;
