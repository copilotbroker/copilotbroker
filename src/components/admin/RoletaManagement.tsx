              ...
              <div key={roleta.id} className="bg-[#1e1e22] border border-[#2a2a2e] rounded-xl overflow-hidden">
                ...
                {isExpanded && (
                  <div className="border-t border-[#2a2a2e] p-4 space-y-4">
                    ...
                    {/* Distribution Mode — disponível para todas as roletas */}
                      ...
                      >
                        ...
                        <label className="flex items-start gap-2 cursor-pointer mt-1">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-muted-foreground">Lead aparece para todos os corretores online em "Pré-Atendimento".</p>
                          </div>
                        </label>
                      </RadioGroup>
                    </div>
