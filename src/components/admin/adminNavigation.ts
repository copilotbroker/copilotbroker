import { Building2, CalendarDays, LayoutDashboard, Users, Bot, BarChart3, List, RotateCw } from "lucide-react";
...
export const ADMIN_TAB_LABELS: Record<AdminRouteTabId, { title: string; subtitle?: string }> = {
  ...
  inbox: { title: "Meu WhatsApp", subtitle: "Gerencie conversas e atendimento em tempo real" },
  plantao: { title: "WhatsApp do Plantão", subtitle: "Conversas da instância global de multi-atendimento" },
