...
import {
  ...
  ChevronUp, Zap, Globe, UserPlus, Megaphone, HelpCircle, GitMerge, Phone
} from "lucide-react";
...
const INTERACTION_META: Record<string, {
  ...
  whatsapp_manual: { icon: MessageCircle, label: "Atendimento WhatsApp", color: "text-emerald-400", dotColor: "bg-emerald-500", isHighlight: true },
  ligacao: { icon: Phone, label: "Ligação Telefônica", color: "text-blue-400", dotColor: "bg-blue-500", isHighlight: true },
  lead_unificado: { icon: GitMerge, label: "Lead Unificado", color: "text-cyan-400", dotColor: "bg-cyan-500", isHighlight: true },
};
