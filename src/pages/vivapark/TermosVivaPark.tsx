...
const TermosVivaPark = () => {
  return (
    <div className="vivapark-theme min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-card/90 backdrop-blur-md border-b border-border/50">
        <div className="max-w-6xl mx-auto py-4 px-4 flex items-center justify-between">
          <Link
            to="/portobelo/vivapark#cadastro"
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 md:py-12 lg:py-20">
        <div className="space-y-12 md:space-y-16">
            ...
            <div className="space-y-6 md:space-y-8 text-muted-foreground text-sm sm:text-base">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2 md:ml-4">
                  <li>Entrar em contato com o titular para envio de informações sobre o empreendimento Vivapark Porto Belo;</li>
          ...
          <section id="termos-de-uso">
            ...
            <p className="text-muted-foreground/60 text-sm mb-6 md:mb-8">Formulário de Divulgação – Vivapark Porto Belo</p>
            <div className="space-y-6 md:space-y-8 text-muted-foreground text-sm sm:text-base">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2 md:ml-4">
                  <li>Receber informações sobre o empreendimento Vivapark Porto Belo;</li>
              ...
              <div>
                ...
                <p className="leading-relaxed">Fica eleito o foro da comarca de <strong className="text-foreground">Porto Belo/SC</strong> para dirimir eventuais controvérsias.</p>
              </div>
            </div>
          </section>
          ...
          <div className="text-center pt-4 md:pt-8">
            <Link
              to="/portobelo/vivapark#cadastro"
              className="inline-flex items-center gap-2 btn-primary px-8 py-4 text-xs"
            >
              <ArrowLeft className="w-4 h-4" />
              Voltar ao cadastro
            </Link>
