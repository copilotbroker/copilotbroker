...
const TermosAuraLegano = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-50 bg-card border-b border-border">
        <div className="container py-4 flex items-center justify-between">
          <Link to="/novasantarita/auralegano#cadastro" className="inline-flex items-center gap-2 text-foreground hover:text-primary transition-colors text-sm min-h-[44px] px-2">
      ...
      <main className="container py-8 md:py-12 lg:py-20">
        <div className="max-w-3xl mx-auto space-y-12 md:space-y-16">
          ...
          <section id="politica-de-privacidade">
            ...
            <div className="space-y-6 text-muted-foreground text-sm sm:text-base">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Envio de informações sobre o empreendimento Aura Legano em Nova Santa Rita;</li>
          ...
          <section id="termos-de-uso">
            ...
            <p className="text-muted-foreground text-sm mb-6">Empreendimento Aura Legano, Nova Santa Rita/RS</p>
            ...
            <div className="space-y-6 text-muted-foreground text-sm sm:text-base">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>Não garante reserva de lote;</li>
              ...
              <div>
                ...
                <p className="leading-relaxed">Imagens, plantas, perspectivas e materiais apresentados são meramente ilustrativos. As características finais serão aquelas dos documentos oficiais da urbanizadora.</p>
              </div>
              <div>
          ...
          <div className="text-center pt-4">
            <Link to="/novasantarita/auralegano#cadastro" className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-medium uppercase tracking-[0.15em] text-xs hover:bg-primary/90 transition-colors min-h-[48px] rounded-md">
              <ArrowLeft className="w-4 h-4" />
              Voltar ao cadastro
            </Link>
          </div>
...
export default TermosAuraLegano;
