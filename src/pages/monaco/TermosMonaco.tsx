...
const TermosMonaco = () => {
  return (
    <div className="min-h-screen bg-[hsl(215,45%,8%)]">
      <header className="sticky top-0 z-50 bg-[hsl(215,45%,8%)] border-b border-[hsl(35,35%,50%)]/15">
      ...
      <main className="container py-8 md:py-12 lg:py-20">
        <div className="max-w-3xl mx-auto space-y-12 md:space-y-16">
          ...
          <hr className="border-[hsl(35,35%,50%)]/15" />
          ...
          <section id="termos-de-uso">
            ...
            <p className="text-white/50 text-sm mb-6 md:mb-8">Formulário de Divulgação – Mônaco Grand Marina, Xangri-lá/RS</p>
            <div className="space-y-6 md:space-y-8 text-white/60 text-sm sm:text-base">
              <div>
              ...
              <div>
                ...
                <p className="leading-relaxed">Fica eleito o foro da comarca de <strong className="text-white">Xangri-lá/RS</strong> para dirimir eventuais controvérsias.</p>
              </div>
            </div>
          </section>
          ...
          <div className="text-center pt-4 md:pt-8">
            <Link
              to="/xangrila/monaco#cadastro"
              className="inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-[hsl(35,35%,45%)] text-white font-medium uppercase tracking-[0.15em] text-xs hover:bg-[hsl(35,35%,38%)] transition-colors min-h-[48px] rounded"
            >
              <ArrowLeft className="w-4 h-4" />
              Voltar ao cadastro
            </Link>
